...
export function OrderSummary() {
  ...
  const { selectedServices, slot, discount, voucherCode } = useSelector((state: RootState) => state.booking)
  ...
  const handleApplyVoucher = () => {
    const voucher = voucherCodes.find(voucher => voucher.code === voucherCode || voucher.name === voucherCode)
    if (voucher) {
