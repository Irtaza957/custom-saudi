    ...
    <div dir={locale === 'ar' ? 'rtl' : 'ltr'}  className="mx-auto px-4 md:px-6 pt-6 md:p-6 space-y-8 md:h-[calc(100vh-260px)] no-scrollbar overflow-auto">
      ...
      <div className="space-y-6">
        ...
        <RadioGroup dir={locale === 'ar' ? 'rtl' : 'ltr'} defaultValue="card" className="space-y-1.5 md:space-y-4">
          ...
          {/* Tamara Option */}
          <div className="flex items-start space-x-2 border rounded-lg p-4 bg-white" onClick={() => handleChange('tamara')}>
          ...
          {/* Tabby Option */}
          <div className="flex items-start space-x-2 border rounded-lg p-4 bg-white" onClick={() => handleChange('tabby')}>
